...
public class OntologyBuilder {
	...
	public void loadReviews() throws Exception {
		...
		if (domain.equals("restaurant")) {
			...
			try {
				this.wordFrequencyDocument = readJSON.readJSONObjectFile(Framework.EXTERNALDATA_PATH + "wordFrequencyDocumentYelpAuto5001.json"); //wordFrequencyReviewYelpAuto5001_multiwords
			} catch (ClassNotFoundException | JSONException | IOException e) {
				e.printStackTrace();
			}
